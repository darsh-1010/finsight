...
down_revision: Union[str, Sequence[str], None] = '4647d8eb4805'
...
def upgrade() -> None:
    ...
    op.create_table('tier_entitlements',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_tier_entitlements_id'), 'tier_entitlements', ['id'], unique=False)
