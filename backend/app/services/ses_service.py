...
class SESService:
    ...
    def send_email(self, to_email: str, subject: str, html_content: str):
        ...
        if not self.sender_email:
            ...
            logger.warning("SES_SENDER_EMAIL not configured. Email to %s not sent.", to_email)
            return False
        ...
        try:
            ...
            logger.info("Email sent to %s. Message ID: %s", to_email, response["MessageId"])
            return True
    ...
    def send_verification_email(self, user_email: str, token: str, tier_name: str = "Foundation", tier_features: list[str] = None):
